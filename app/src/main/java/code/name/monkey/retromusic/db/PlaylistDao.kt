...
interface PlaylistDao {
    ...
    @Query("UPDATE SongEntity SET title = :title, artist_name = :artist, album_name = :album, duration = :duration, year = :year, track_number = :trackNumber, bitrate = :bitrate, size = :size, format = :format, sampleRate = :sampleRate, artist_id = :artistId, artistNames = :artistNames, artistIds = :artistIds, coverPath = :coverPath WHERE id = :songId")
