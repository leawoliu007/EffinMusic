...
interface PlaylistDao {
    ...
    @Query("UPDATE SongEntity SET title = :title, artist_name = :artist, album_name = :album, duration = :duration, year = :year, track_number = :trackNumber, bitrate = :bitrate, size = :size WHERE id = :songId")
